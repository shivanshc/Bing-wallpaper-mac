'''es Cocoa classes via PyObjC to set a random desktop picture on all screens.
...
pictures_glob = glob.glob("/Users/Chandnanis/Documents/projects/bing-wallpaper/hello3.jpg")
picture_path = pictures_glob
